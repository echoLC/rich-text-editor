module.exports = {
  types: [
    ...
    },
    {
      value: 'ci',
      name:
        '🕓  ci: Changes to our CI configuration files and scripts (example scopes: Circle, Docker, BrowserStack)',
    },
    {
      value: 'docs',
    ...
    },
    {
      value: 'workflow',
      name:
        '📦  [NOT RECOMMENDED] workflow: Changes that only affect the workflow. Such as updateing build systems or CI etc.',
    },
  ],
